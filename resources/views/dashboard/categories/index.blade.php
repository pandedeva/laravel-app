      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            <a href="/dashboard/categories/{{ $category->slug }}" class="badge bg-dark text-light"><span data-feather="eye"></span></a>
            {{-- tombol edit --}}
            <a href="/dashboard/categories/{{ $category->slug }}/edit" class="badge bg-warning text-dark rounded-pill"><span data-feather="edit"></span></a>
            {{-- tombol delete --}}
